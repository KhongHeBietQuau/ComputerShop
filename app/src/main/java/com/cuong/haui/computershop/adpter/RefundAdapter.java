...
public class RefundAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RefundAdapter(Context context, List<SaleOrder> array) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if(viewType == VIEW_TYPE_DATA) {
            ...
            return new RefundAdapter.MyViewHolder(view);
        }
        else {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_loading,parent,false);
            return new RefundAdapter.LoadingViewHolder(view);
        }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof RefundAdapter.MyViewHolder) {
            RefundAdapter.MyViewHolder myViewHolder = (RefundAdapter.MyViewHolder) holder;
            ...
            if(saleOrder.shipper_id==1){
                myViewHolder.btn_cancel.setText("Yêu cầu trả hành");
                myViewHolder.itemdt_status_refund.setText("Ko yêu cầu");
            }
            else{
                myViewHolder.btn_cancel.setText("Hủy yêu cầu trả hành");
            ...
            myViewHolder.btn_cancel.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    builder.setMessage("Bạn có chắc với lựa chọn của mình?");
                    builder.setPositiveButton("Đồng ý", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {

                            FirebaseDatabase database = FirebaseDatabase.getInstance();
                            DatabaseReference myRef = database.getReference("SaleOrders/"+String.valueOf(saleOrder.sale_order_id)+ "/shipper_id");
                            if(saleOrder.shipper_id==1) {
            ...
            RefundAdapter.LoadingViewHolder loadingViewHolder = (RefundAdapter.LoadingViewHolder) holder;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            itemdt_status_refund = itemView.findViewById(R.id.itemdt_status_refund);
            ...
            btn_cancel= itemView.findViewById(R.id.btn_cancel_refund);
