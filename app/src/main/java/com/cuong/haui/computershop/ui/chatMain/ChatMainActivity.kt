package com.cuong.haui.computershop.ui.chatMain
...
class ChatMainActivity : BaseActivity<ActivityChatMainBinding>() {
        ...
        mDbRef.child("Users").addValueEventListener(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for(postSnashot in snapshot.children){
                    ...
                    if(DefaultFirst1.userCurrent.user_id != currentUser?.user_id && currentUser?.role == 2)
    ...
    override fun inflateViewBinding(inflater: LayoutInflater): ActivityChatMainBinding {
        return ActivityChatMainBinding.inflate(inflater)
    }
