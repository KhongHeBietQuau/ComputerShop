...
public class RefundAdminAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
    List<SaleOrder> array;
    private static final int VIEW_TYPE_DATA = 0;
    private static final int VIEW_TYPE_LOADING = 1;

    public RefundAdminAdapter(Context context, List<SaleOrder> array) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if(viewType == VIEW_TYPE_DATA) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_refund_admin,parent,false);
            return new RefundAdminAdapter.MyViewHolder(view);
        }
        else {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_loading,parent,false);
            return new RefundAdminAdapter.LoadingViewHolder(view);
        }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof RefundAdminAdapter.MyViewHolder) {
            RefundAdminAdapter.MyViewHolder myViewHolder = (RefundAdminAdapter.MyViewHolder) holder;
            ...
            if(saleOrder.shipper_id==1){
                myViewHolder.btn_cancel.setVisibility(View.INVISIBLE);
                myViewHolder.itemdt_status_refund.setText("Ko yêu cầu");
            }
            else{
                myViewHolder.btn_cancel.setVisibility(View.VISIBLE);
                myViewHolder.btn_cancel.setText("Chấp nhận trả hàng");
                myViewHolder.itemdt_status_refund.setText("Có yêu cầu");
            }
            ...
            myViewHolder.btn_cancel.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    builder.setMessage("Bạn có chắc muốn chấp nhận trả hàng không?");
                    builder.setPositiveButton("Đồng ý", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            if(saleOrder.shipper_id==0) {
                                ...
                                myRef.setValue("0", new DatabaseReference.CompletionListener() {
                                    ...
                                    public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                                        Toast.makeText(view.getContext(), "Xác nhận thành công", Toast.LENGTH_LONG).show();
                                    }
                                });
            ...
            RefundAdminAdapter.LoadingViewHolder loadingViewHolder = (RefundAdminAdapter.LoadingViewHolder) holder;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        TextView tensp,giasp,nguoinhan,mota,sodienthoai,tongtien,phuongthucthanhtoan,trangthaithanhtoan,ghichu,itemdt_address,itemdt_status_refund;
        ImageView hinhanh;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            itemdt_status_refund= itemView.findViewById(R.id.itemdt_status_refund_admin);
            ...
            btn_cancel= itemView.findViewById(R.id.btn_cancel_refund_admin);
