...
public class DeliveredAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public DeliveredAdapter(Context context, List<SaleOrder> array) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if(viewType == VIEW_TYPE_DATA) {
            ...
            return new DeliveredAdapter.LoadingViewHolder(view);
        }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof LaptopAdapter.MyViewHolder) {
            ...
            myViewHolder.mota.setText(saleOrder.getSoluong());
            ...
            LaptopAdapter.LoadingViewHolder loadingViewHolder = (LaptopAdapter.LoadingViewHolder) holder;
