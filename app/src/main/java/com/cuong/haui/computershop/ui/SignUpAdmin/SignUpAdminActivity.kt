package com.cuong.haui.computershop.ui.SignUpAdmin
...
import com.cuong.haui.computershop.databinding.ActivitySignUpAdminBinding
...
class SignUpAdminActivity : BaseActivity<ActivitySignUpAdminBinding>() {
    ...
    private fun saveUserInfo(fullName: String?, userName: String?, email: String?, progressDialog: ProgressDialog, password: String?) {
        ...
        val userMap = User(user_id,2,fullName,userName,email,password,"","","https://firebasestorage.googleapis.com/v0/b/instagram-clone-deeb5.appspot.com/o/Default%20Images%2Fprofile.png?alt=media&token=644c083d-fa83-490b-af51-a8855fcdd94b")
        DefaultFirst1.userCurrent.setUser_id(user_id)
        DefaultFirst1.userCurrent.setRole(2)
    ...
    override fun inflateViewBinding(inflater: LayoutInflater): ActivitySignUpAdminBinding {
        return ActivitySignUpAdminBinding.inflate(inflater)
    }
