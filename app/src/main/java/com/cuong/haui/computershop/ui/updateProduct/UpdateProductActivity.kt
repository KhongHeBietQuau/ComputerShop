package com.cuong.haui.computershop.ui.updateProduct
...
import com.cuong.haui.computershop.adpter.UpdateProductAdapter
import com.cuong.haui.computershop.base.BaseActivity
import com.cuong.haui.computershop.databinding.ActivityStopSellingBinding
import com.cuong.haui.computershop.databinding.ActivityUpdateProductBinding
...
class UpdateProductActivity : BaseActivity<ActivityUpdateProductBinding>() {
    var database = FirebaseDatabase.getInstance()
    private lateinit var spAdapter : UpdateProductAdapter
    ...
    private fun InitData(){
        ...
        spAdapter = UpdateProductAdapter(applicationContext, mangSpMoi)
    ...
    override fun inflateViewBinding(inflater: LayoutInflater): ActivityUpdateProductBinding {
        return ActivityUpdateProductBinding.inflate(inflater)
    }
